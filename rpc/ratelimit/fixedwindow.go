...
// key string object for rate limit such as uid/ip+url
// fillInterval time.Duration such as 1*time.Second
// limitNum max int64 allowed number per fillInterval
// eturn whether reach rate limit, false means reach
